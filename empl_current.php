...
error_reporting(E_ALL);
	...
	$query_emplcurr = getCurrentEmployee($db_link);
?>
...
<html>
	...
	<body>
		...
		<div id="menu_main">
			...
			<a href="empl_current.php" id="item_selected">Current Employees</a>
		</div>
		...
		<table id="tb_table">
			...
			while ($row_emplcurr = mysqli_fetch_assoc($query_emplcurr)){
				...
				echo '<tr>
								<td><a href="employee.php?empl='.$row_emplcurr['empl_id'].'">'.$row_emplcurr['empl_number'].'</a></td>
								<td>'.$row_emplcurr['empl_name'].'</td>
								<td>'.$row_emplcurr['empl_position'].'</td>
								<td>'.$row_emplcurr['empl_gender'].'</td>
								...
								<td>'.date("d.m.Y",$row_emplcurr['empl_start']).'</td>
							</tr>';

				array_push($_SESSION['rep_export'], array("Empl. No." => $row_emplcurr['empl_number'], 
				"Employee Name" => $row_emplcurr['empl_name'], "DoB" => date("d.m.Y",$row_emplcurr['empl_dob']), 
				"Gender" => $row_emplcurr['empl_gender'], "Address" => $row_emplcurr['empl_address'], 
				"Phone No." => $row_emplcurr['empl_phone'], "Email" => $row_emplcurr['empl_email'], 
				"Empl. In" => date("d.m.Y",$row_emplcurr['empl_start'])));
