...
<p style="font-weight:Bold">Add New Chemical</p>
<form method="post" action="season.php" name="create_season">
</br>
</br>
<p>name<p>
</br>
<input name ="chem_name" type="text" placeholder="name of chemical"/>
</br>
</br>
<p>Type<p>
</br>
<input name="chem_type" type="text" placeholder="preservative/weeds_control etc"/>
</br>
</br>
<p> Description</p>
</br>
<input name="chem_description" type="text" placeholder=""/>
</br>
</br>
<p>Quantity<p>
<br>
<input name="chem_quantity" type="text" placeholder="2.l/2.5Kg etc"/>
<br>
<br>
<p> Price</p>
</br>
<input name="chem_price" type="numeric" placeholder="kshs"/>
</br>
</br>

<input name="add_chem" type ="submit" value = "Add Chem"/>
</form>
</div>
