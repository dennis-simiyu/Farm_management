...
error_reporting(E_ALL);
	...
	if(isset($_POST['adminSetup'])){
		...
		$admin_pass = password_hash ((sanitize($db_link, $_POST['admin_pass'])), PASSWORD_DEFAULT);
		$timestamp = time();

		// Insert new admin user into database
		$sql_makeadmin = "INSERT INTO user (user_name, empl_id, ugroup_id,user_pw,user_created)
		 VALUES ('$admin_name','0', '1','$admin_pass','$timestamp')";
...
<html>
	<head>
		...
		<script src="function_validate.js"></script>
	</head>
	<body>
		<div class="content_center">
			<p class="heading">Agritech Setup Assistant</p>
